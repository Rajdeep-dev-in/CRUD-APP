        ...
        <>
            <div className=" bg-blue-300 text-black rounded-md shadow-lg">
                ...
                <div className="flex justify-end items-end gap-2 px-3 py-2">
                    <div>
                        <button className="px-1 py-1 bg-green-600 text-white hover:bg-green-700 cursor-pointer">
                            Edit
                        </button>
                    </div>
                    <div>
                        <button className="px-1 py-1 bg-red-500 text-white hover:bg-red-600 cursor-pointer">
                            Delete
                        </button>
                    </div>
                </div>
